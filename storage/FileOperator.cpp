#include "storage/FileOperator.h"
#include <QIcon>
#include <QDir>
#include <QFile>
#include <QDateTime>
...
void FileOperator::saveWeapon()  //保存武器（用于快速自定义武器功能）
{

}

void FileOperator::saveEnchantmentTable()    //保存魔咒（用于快速自定义魔咒功能）
{
...
void FileOperator::loadWeapon()  //加载武器
{
...
void FileOperator::loadEnchantmentTable()    //加载魔咒
{
...
void FileOperator::saveExport(QString dir_str)  //保存输出结果
{
    QDir dir;
